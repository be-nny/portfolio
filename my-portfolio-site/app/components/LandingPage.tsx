    ...
    return(
        <div>
            ...
            <div className={styles.aboutLayout}>
                <div className={`${styles.subText} ${styles.contentLeft}`}>
                ...
                <div className={`${styles.canvasContainer} ${styles.contentRight}`}>
                    <div id={"canvas1"} className={`${styles.canvas1} ${styles.contentRight}`}></div>
                </div>
            </div>
        </div>
    );
