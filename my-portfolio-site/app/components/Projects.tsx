        ...
        <div className={styles.categoryGrid }>
            <div className={`card ${styles.card}`}>
                ...
                <div className="card-body">
                    ...
                    <p className="card-text">This was my second year group software engineering project to gamify
                        sustainability on our campus using a webscraper Players earnt points by scanning a barcode before
                        throwing away their rubbish.</p>
                    <a href="https://github.com/be-nny/proj-iSABEL" className="card-link">See inside!</a>
                </div>
            ...
            <div className={`card ${styles.card}`}>
                ...
                <div className="card-body">
                    ...
                    <a href="https://github.com/be-nny/CCD-keras" className="card-link">See inside!</a>
                </div>
                <ul className="list-group list-group-flush">
            ...
            <div className={`card ${styles.card}`}>
                ...
                <div className="card-body">
                    ...
                    <a href="https://github.com/be-nny/connect-four-robot" className="card-link">See inside!</a>
                </div>
                <ul className="list-group list-group-flush">
